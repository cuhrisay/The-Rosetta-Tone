  ...
  return (
    <section className={cn("bg-secondary py-20 text-secondary-foreground md:py-28", className)}>
      <div className="container max-w-3xl text-center">
        {eyebrow && (
          <p className="mb-4 text-sm font-medium uppercase tracking-wide-lg text-gold">{eyebrow}</p>
        )}
        <h1 className="text-balance font-serif text-4xl font-medium md:text-5xl">{title}</h1>
